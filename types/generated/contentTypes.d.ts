...
export interface ApiCustomerCustomer extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    PendingAmount: Schema.Attribute.Integer;
    publishedAt: Schema.Attribute.DateTime;
    servicings: Schema.Attribute.Relation<
      'oneToMany',
      'api::servicing.servicing'
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiInvoiceInvoice extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    InvoiceNumber: Schema.Attribute.BigInteger;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::invoice.invoice'
    ...
    Name: Schema.Attribute.String;
    Particular: Schema.Attribute.Text;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiServicingServicing extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    ChooseServiceGiven: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    ExtraWork: Schema.Attribute.Text;
    items: Schema.Attribute.Relation<'manyToMany', 'api::item.item'>;
    ItemsUsed: Schema.Attribute.Text;
    ...
    PaidInCash: Schema.Attribute.BigInteger &
      Schema.Attribute.SetMinMax<
        {
          min: '0';
        },
      ...
      > &
      Schema.Attribute.DefaultTo<'0'>;
    PaidOnline: Schema.Attribute.BigInteger &
      Schema.Attribute.SetMinMax<
        {
          min: '0';
        },
